![writed.xyz-banner](/public/static/images/logo.png)

# "Writed."

[Writed.xyz](https://writed.xyz) is a personal website aimed to showcase projects, blogs, learnings etc. Design is based on [template](<(https://github.com/timlrx/tailwind-nextjs-starter-blog)>) made by @timlrx.

## Features

Mostly preserves the feature set provided by the original author:
